...
def test_eq_stack(cards_5):
    ...
    assert CardStack(seed=1, cards=cards_5.copy()) == CardStack(seed=1, cards=cards_5.copy())

    assert CardStack(seed=1) != CardStack(seed=2)
    assert CardStack(seed=1, cards=cards_5.copy()) != CardStack(seed=2, cards=cards_5.copy())
    assert CardStack(seed=1, cards=cards_5.copy()) != CardStack(seed=1)
    assert CardStack(seed=1, cards=cards_5.copy()) != CardStack(seed=1, cards=cards_5.copy()[:2])
...
@pytest.mark.parametrize("input_color,expected_color", [
    ('RED', 'red'),
    ('BlUe', 'blue'),
    ('green', 'green'),
    ('BLUE', 'blue'),
