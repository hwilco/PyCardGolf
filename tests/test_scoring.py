...
@pytest.mark.parametrize("ranks,expected_score", [
    pytest.param(
        [(Rank.ACE, Suit.CLUBS), (Rank.TWO, Suit.CLUBS), (Rank.THREE, Suit.CLUBS),
         (Rank.FOUR, Suit.CLUBS), (Rank.FIVE, Suit.CLUBS), (Rank.SIX, Suit.CLUBS)],
        17,
        id="simple_sum_no_pairs"
    ),
    pytest.param(
        [(Rank.FIVE, Suit.CLUBS), (Rank.TWO, Suit.CLUBS), (Rank.THREE, Suit.CLUBS),
         (Rank.FIVE, Suit.DIAMONDS), (Rank.FOUR, Suit.CLUBS), (Rank.SIX, Suit.CLUBS)],
        11,
        id="one_pair_cancels"
    ),
    pytest.param(
        [(Rank.KING, Suit.CLUBS), (Rank.QUEEN, Suit.CLUBS), (Rank.JACK, Suit.CLUBS),
         (Rank.KING, Suit.DIAMONDS), (Rank.TWO, Suit.CLUBS), (Rank.ACE, Suit.CLUBS)],
        19,
        id="face_cards_and_king_pair"
    ),
    pytest.param(
        [(Rank.KING, Suit.CLUBS), (Rank.THREE, Suit.CLUBS), (Rank.FOUR, Suit.CLUBS),
         (Rank.FIVE, Suit.CLUBS), (Rank.SIX, Suit.CLUBS), (Rank.SEVEN, Suit.CLUBS)],
        25,
        id="king_worth_zero"
    ),
    pytest.param(
        [(Rank.THREE, Suit.CLUBS), (Rank.SEVEN, Suit.CLUBS), (Rank.NINE, Suit.CLUBS),
         (Rank.THREE, Suit.DIAMONDS), (Rank.SEVEN, Suit.HEARTS), (Rank.NINE, Suit.SPADES)],
        0,
        id="all_pairs_cancel"
    ),
    pytest.param(
        [(Rank.TWO, Suit.CLUBS), (Rank.TWO, Suit.DIAMONDS), (Rank.TWO, Suit.HEARTS),
         (Rank.KING, Suit.CLUBS), (Rank.KING, Suit.DIAMONDS), (Rank.KING, Suit.SPADES)],
        -6,
        id="negative_score"
    ),
    pytest.param(
        [(Rank.KING, Suit.CLUBS), (Rank.KING, Suit.DIAMONDS), (Rank.KING, Suit.HEARTS),
         (Rank.KING, Suit.SPADES), (Rank.KING, Suit.CLUBS), (Rank.KING, Suit.DIAMONDS)],
        0,
        id="all_kings"
    ),
])
...
@pytest.mark.parametrize("hand_size", [
